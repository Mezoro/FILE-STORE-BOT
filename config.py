...
BOT_TOKEN = environ.get("BOT_TOKEN", "8036793469:AAHHkzHlCacrMSjN3ajofwTWAWCurXEfio0")

PICS = (environ.get('PICS', 'https://graph.org/file/ce1723991756e48c35aa1.jpg')).split() # Bot Start Picture
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6380847042').split()]
BOT_USERNAME = environ.get("BOT_USERNAME", "Jsjsbjdjd_bot") # without @
...
DB_URI = environ.get("DB_URI", "mongodb+srv://1noadisarkerrnuqHLoTLmV9A0oa@cluster0.4fimk.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DB_NAME = environ.get("DB_NAME", "1noadisarker")
